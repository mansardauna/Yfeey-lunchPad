        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <p className="text-base md:text-lg text-[hsl(var(--dark-section-foreground))]/70 leading-relaxed max-w-xl mb-8 animate-fade-in" style={{ animationDelay: '200ms' }}>
              Empower startups, businesses, and individuals to maximize efficiency and impact through people, technology, AI, and smart automation.
            </p>
            <Button 
              size="lg" 
              onClick={scrollToContact}
              className="text-base px-8 py-6 animate-fade-in bg-white text-[hsl(var(--dark-section))] hover:bg-white/90"
          ...
          <div className="flex-1 flex justify-center lg:justify-end animate-fade-in" style={{ animationDelay: '200ms' }}>
            <img src="/hero.jpeg" alt="Hero Illustration" className="w-full max-w-md lg:max-w-lg" />
          </div>
        </div>
      </div>
    </section>
